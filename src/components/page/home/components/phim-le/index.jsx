          ...
          return (
               <div className="card mt-3 slider-container" >
                    <div className="card-header d-flex justify-content-between align-item-center">
                         <span ><a href="/category/phim-le" className="text-warning"><i className="fe fe-hash"></i> Phim lẻ / Phim chiếu rạp</a></span>
                         <small ><a href="/category/phim-le" className="text-warning">Xem thêm</a></small>
                    </div>
