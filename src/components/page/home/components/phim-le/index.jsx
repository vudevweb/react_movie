     ...
     function PhimLe(props) {
          const {phimLe} = props;

          const [phimLeV1, setpPhimLe] = useState([]);
          ...
          return (
               <div className="card mt-3 slider-container" >
                    <div className="card-header d-flex justify-content-between align-item-center">
                         <span ><Link to="/category/phim-le" className="text-warning"><i className="fe fe-hash"></i> Phim lẻ / Phim chiếu rạp</Link></span>
                         <small ><Link to="/category/phim-le" className="text-warning">Xem thêm</Link></small>
                    </div>
                    <Slider {...settings} className="card-body row">
                         {phimLeV1.map((movie, index) => (
